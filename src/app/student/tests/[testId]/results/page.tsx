          ...
          return (
            <Card key={question.id} className={cn("overflow-hidden", isCorrect ? "border-green-500/50" : "border-destructive/50")}>
              ...
              <CardContent className="p-4 space-y-2">
                <p className="text-sm"><strong>Your Answer:</strong> <span className={cn(isCorrect ? "text-green-700 dark:text-green-400" : "text-destructive")}>{studentAnswerText || "No answer"}</span></p>
                {!isCorrect && (
